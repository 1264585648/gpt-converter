...
function pageFromLocation(): Page {
  ...
  if (legacyRoute === 'converter' || legacyRoute === 'formats' || legacyRoute === 'compare' || legacyRoute === 'security') {
    window.history.replaceState(null, '', `/${legacyRoute}${window.location.search}`)
    return legacyRoute
  }

  const pathname = window.location.pathname.replace(/\/+$/, '') || '/'
  if (pathname === '/converter' || pathname === '/formats' || pathname === '/compare' || pathname === '/security') {
